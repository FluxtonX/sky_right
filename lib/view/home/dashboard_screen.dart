            ...
            children: [
              ...
              GridView.count(
                ...
                children: [
                  ...
                  _buildModuleCard('BorderReady', 'Travel Compliance',
              ...
              GridView.count(
                ...
                childAspectRatio: 1.1,
                children: [
                  _buildModuleCard('BagTrack', 'Baggage Monitor',
                      Icons.luggage_outlined, const Color(0xFFF97316),
                      isLocked: true),
                  _buildModuleCard('Trip Visualizer', 'Journey Map',
                      Icons.map_outlined, const Color(0xFF06B6D4),
                      isLocked: true),
                  _buildModuleCard('Expense Tracker', 'Track Spending',
                      Icons.attach_money, const Color(0xFF10B981),
                      isLocked: true),
                  _buildModuleCard('Claim Submission', 'Submit Claims',
                      Icons.description_outlined, const Color(0xFF6366F1),
                      isLocked: true),
                  _buildModuleCard('Claim Intelligence', 'Analytics',
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      const Color(0xFF26231A),
                      const Color(0xFF1F1D17),
                    ],
                  ),
                  borderRadius: BorderRadius.circular(24),
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            _buildNavItem(Icons.notifications_outlined, 'Alerts', 1),
            _buildNavItem(Icons.auto_awesome_outlined, 'Sentinel', 2),
            _buildNavItem(Icons.folder_outlined, 'Vault', 3),
      ...
      child: Column(
        ...
        children: [
          Icon(
            icon,
            color:
                isSelected ? const Color(0xFFFFC229) : const Color(0xFF9CA3AF),
            size: 24,
          ),
          const SizedBox(height: 4),
          Text(
